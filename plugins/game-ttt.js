import TicTacToe from '../assets/lib/tictactoe.js'
...
`.trim()
		...
		m.reply('Waiting for partners' + (text ? ` type the command below ${usedPrefix}${command} ${text}` : ''))
...
handler.tags = ['game']
handler.command = /^(xo|tictactoe|t{3})$/
