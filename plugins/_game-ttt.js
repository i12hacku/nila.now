...
${arr.slice(3, 6).join('')}
${arr.slice(6).join('')}
${isWin ? `@${winner.split('@')[0]} ජය ඔබට ! (+${winScore} XP)` : isTie ? `ජය පරාජයකින් තොරයි ! (+${playScore} XP)` : `වාරය ඔබේ ! ${['🐰', '🥕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`}
🐰: @${room.game.playerX.split('@')[0]}
🥕: @${room.game.playerO.split('@')[0]}
Type *giveup* for giveup
Room ID: ${room.id}
`.trim()
